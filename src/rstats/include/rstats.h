 ...
 * @param buffer A pointer to an array of two doubles.
 * 
 ...
 * @param buffer A pointer to an array of two doubles with the results
 ...
 * @param w The weight of the new value `x`.
 * @param buffer A pointer to an array of three doubles.
 * 
 ...
 * 
 * @param results A pointer to an array of two doubles where the final mean and 
 * variance values will be stored:
 *                - `results[0]` will store the final mean value.
 *                - `results[1]` will store the final variance value.
 * @param buffer A pointer to an array of three doubles used in 
 * `rstats_variance` to calculate the running statistics.
 * 
 * @note This function should be used to finalize the results obtained by 
 ...
 * @param x The new value to incorporate into the running statistics.
 * @param w The weight of the new value `x`.
 * @param buffer A pointer to an array of four doubles.
 * 
 ...
 * 
 * @param results A pointer to an array of three doubles where the final mean, 
 * variance, and skewness values will be stored:
 *                - `results[0]` will store the final mean value.
 *                - `results[1]` will store the final variance value.
 *                - `results[2]` will store the final skewness value.
 * @param buffer A pointer to an array of four doubles used in `rstats_skewness`
 * to calculate the running statistics.
 * 
 * @note This function should be used to finalize the results obtained by 
 ...
 * @param x The new value to incorporate into the running statistics.
 * @param w The weight of the new value `x`.
 * @param buffer A pointer to an array of five doubles:
 * 
 ...
 * 
 * @param results A pointer to an array of four doubles where the final mean,
 *  variance, skewness, and kurtosis values will be stored:
 *                - `results[0]` will store the final mean value.
 *                - `results[1]` will store the final variance value.
 *                - `results[2]` will store the final skewness value.
 *                - `results[3]` will store the final kurtosis value.
 * @param buffer A pointer to an array of five doubles used in `rstats_kurtosis`
 * to calculate the running statistics.
 * 
 * @note This function should be used to finalize the results obtained by 
